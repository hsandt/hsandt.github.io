...
tags: ue4 blueprints
image: "/assets/pictures/blog/how-to/2017-02-14-blueprint-defined-behavior-with-dynamic-multicast-delegates-in-unreal-engine/thumbnail.png"
thumbnail: "2017-02-14-blueprint-defined-behavior-with-dynamic-multicast-delegates-in-unreal-engine/thumbnail.png"
---
...
![WallSwitch Actor blueprint with SwitchableComponent](/assets/pictures/blog/how-to/2017-02-14-blueprint-defined-behavior-with-dynamic-multicast-delegates-in-unreal-engine/UE4-delegate-blueprint-BP_WallSwitch-components.png)

When we select the Switchable Component, the Details panel shows:

![Switchable Component details panel with OnSwitch event View button](/assets/pictures/blog/how-to/2017-02-14-blueprint-defined-behavior-with-dynamic-multicast-delegates-in-unreal-engine/UE4-delegate-blueprint-BP_WallSwitch-details.png)
...
![On Switch event, no binding](/assets/pictures/blog/how-to/2017-02-14-blueprint-defined-behavior-with-dynamic-multicast-delegates-in-unreal-engine/UE4-delegate-blueprint-BP_WallSwitch-Event-Graph-no-binding.png)
...
![Binding for Switchable Component OnSwitch event on Wall Switch actor](/assets/pictures/blog/how-to/2017-02-14-blueprint-defined-behavior-with-dynamic-multicast-delegates-in-unreal-engine/UE4-delegate-blueprint-BP_WallSwitch-Event-Graph.png)

# Result

When the player character tries to interact with the Wall Switch, the level sequence plays:

![Player Character uses Switch to move Wall](/assets/pictures/blog/how-to/2017-02-14-blueprint-defined-behavior-with-dynamic-multicast-delegates-in-unreal-engine/UE4-Blueprint-delegates-On-Switch-action.gif)
...
![Level Blueprint binding action to On Switch delegate](/assets/pictures/blog/how-to/2017-02-14-blueprint-defined-behavior-with-dynamic-multicast-delegates-in-unreal-engine/UE4-delegate-blueprint-Switch-level-event.png)
